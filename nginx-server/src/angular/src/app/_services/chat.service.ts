...
export class ChatService {
  ...
  fetchFriends(): Observable<any> {
    return this.httpClient.post(`${environment.DOMAIN}/api/chat`, this.httpOptions)
  ...
  createFriend(email: String): Observable<any> {
    return this.httpClient.get(`${environment.DOMAIN}/api/chat?email=${email}`, this.httpOptions)
